...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,642 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,384 | 🐛 9 | 🌐 Python | 📅 2026-09-10 🆓 - Automated unit test generation for Python via evolutionary algorithms, from Saarland University.
...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 779 | 🐛 45 | 🌐 Kotlin | 📅 2026-09-10 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 51,573 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-10 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,983 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-09 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 13,221 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-03 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
* [BrowserTools MCP](https://github.com/AgentDeskAI/browser-tools-mcp) ⭐ 7,319 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12 🆓 - Browser monitoring and console log access for AI agents via Chrome extension.
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 7,070 | 🐛 147 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
...
* [qmax-mcp](https://github.com/Quality-Max/qmax-mcp) ⭐ 2 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-10 🆓 - MCP server and CLI that gives coding agents independent QA evidence before declaring a web change done: scans a URL for console errors, broken links, accessibility, Core Web Vitals, SEO, and security headers, then generates and runs a deterministic Playwright repro behind a human-approval gate.

## Self-Healing Test Frameworks

Tools that automatically repair broken test locators and adapt to UI changes.

* [CodeceptJS](https://github.com/codeceptjs/CodeceptJS) ⭐ 4,242 | 🐛 209 | 🌐 JavaScript | 📅 2026-09-10 🆓 - End-to-end testing framework with built-in AI heal plugin that uses OpenAI, Anthropic, or local models to repair failing steps and propose locator fixes.
...
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 909 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 🆓 - Self-improving QA agent for natural-language web and mobile tests with run memory, UI-change adaptation, and regression detection.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,571 | 🐛 513 | 🌐 Kotlin | 📅 2026-09-10 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [Argos](https://github.com/argos-ci/argos) ⭐ 621 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,829 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-10 🆓 - AI-driven UI automation with natural language commands.
...
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 4,270 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-10 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,446 | 🐛 926 | 🌐 TypeScript | 📅 2026-09-10 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,007 | 🐛 652 | 🌐 TypeScript | 📅 2026-09-10 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,922 | 🐛 253 | 🌐 Python | 📅 2026-09-10 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,425 | 🐛 337 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 18,208 | 🐛 576 | 🌐 Python | 📅 2026-09-08 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,698 | 🐛 596 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,944 | 🐛 958 | 🌐 Python | 📅 2026-09-10 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,410 | 🐛 969 | 🌐 Python | 📅 2026-09-10 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,903 | 🐛 302 | 🌐 Jupyter Notebook | 📅 2026-09-10 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,142 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-31 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,546 | 🐛 59 | 🌐 Python | 📅 2026-09-10 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,530 | 🐛 938 | 🌐 TypeScript | 📅 2026-09-10 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,747 | 🐛 294 | 🌐 Python | 📅 2026-09-10 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,127 | 🐛 224 | 🌐 Python | 📅 2026-09-10 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 131 | 🐛 8 | 🌐 Rust | 📅 2026-09-07 🆓 - Local-first TUI and CLI for evaluating AI coding agent sessions with cost, token, latency, and failure regression gates.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,100 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-10 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,489 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-10 🆓 - Standard fake data library, often paired with AI for context-aware data.
...
* [MSW (Mock Service Worker)](https://github.com/mswjs/msw) ⭐ 18,200 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-10 🆓 - API mocking library for browser and Node.js, ideal for frontend AI testing.
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,397 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-10 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,368 | 🐛 503 | 🌐 Java | 📅 2026-09-08 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
* [Hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,513 | 🐛 35 | 🌐 Go | 📅 2026-09-07 🆓 - Lightweight service virtualization with proxy-based recording and replay.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,438 | 🐛 808 | 🌐 Go | 📅 2026-09-10 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Pa11y](https://github.com/pa11y/pa11y) ⭐ 4,522 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 🆓 - Open-source automated accessibility testing tool.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,453 | 🐛 726 | 🌐 Go | 📅 2026-09-10 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,180 | 🐛 420 | 🌐 Python | 📅 2026-09-09 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,389 | 🐛 79 | 🌐 Python | 📅 2026-09-08 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,100 | 🐛 227 | 🌐 Python | 📅 2026-09-10 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,809 | 🐛 63 | 🌐 Python | 📅 2026-09-09 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,778 | 🐛 64 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 114,075 | 🐛 426 | 🌐 Python | 📅 2026-09-10 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 35,264 | 🐛 103 | 🌐 Zig | 📅 2026-09-10 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,201 | 🐛 364 | 🌐 TypeScript | 📅 2026-09-10 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,971 | 🐛 234 | 🌐 Python | 📅 2026-09-10 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,614 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-03 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,520 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-09 🆓 - Patched Playwright for stealth automation.
* [Notte](https://github.com/nottelabs/notte) ⭐ 2,001 | 🐛 13 | 🌐 Python | 📅 2026-09-10 🆓 - Web agent framework for building fast, cost-efficient AI agents that automate web interactions using natural language instructions, with browser session management, structured data extraction, and anti-detection support.
* [AgentQL](https://github.com/tinyfish-io/agentql) ⭐ 1,456 | 🐛 10 | 🌐 Python | 📅 2026-08-26 🆓💰 - Natural language query language for AI agents to interact with and extract structured data from web pages, with self-healing selectors that integrate with Playwright.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,818 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,722 | 🐛 77 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,369 | 🐛 45 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,135 | 🐛 204 | 🌐 Python | 📅 2026-08-30 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
...
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,607 | 🐛 103 | 🌐 Python | 📅 2025-11-26 - Self-hostable web environment for building and evaluating autonomous agents on realistic, multi-site tasks.
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,430 | 🐛 53 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,156 | 🐛 137 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,693 | 🐛 215 | 📅 2025-08-20 - LLM security tools and resources.
