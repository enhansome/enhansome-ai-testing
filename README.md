...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,644 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,386 | 🐛 7 | 🌐 Python | 📅 2026-09-13 🆓 - Automated unit test generation for Python via evolutionary algorithms, from Saarland University.
...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 779 | 🐛 53 | 🌐 Kotlin | 📅 2026-09-13 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 51,825 | 🐛 109 | 🌐 TypeScript | 📅 2026-09-13 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,060 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-11 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 13,274 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
* [BrowserTools MCP](https://github.com/AgentDeskAI/browser-tools-mcp) ⭐ 7,318 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-12 🆓 - Browser monitoring and console log access for AI agents via Chrome extension.
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 7,082 | 🐛 149 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
* [ExecuteAutomation Playwright MCP](https://github.com/executeautomation/mcp-playwright) ⭐ 5,644 | 🐛 35 | 🌐 TypeScript | 📅 2025-12-13 🆓 - Community Playwright MCP server with API testing support and 143 device emulation profiles.
...
* [qmax-mcp](https://github.com/Quality-Max/qmax-mcp) ⭐ 2 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-12 🆓 - MCP server and CLI that gives coding agents independent QA evidence before declaring a web change done: scans a URL for console errors, broken links, accessibility, Core Web Vitals, SEO, and security headers, then generates and runs a deterministic Playwright repro behind a human-approval gate.

## Self-Healing Test Frameworks

Tools that automatically repair broken test locators and adapt to UI changes.

* [CodeceptJS](https://github.com/codeceptjs/CodeceptJS) ⭐ 4,240 | 🐛 210 | 🌐 JavaScript | 📅 2026-09-12 🆓 - End-to-end testing framework with built-in AI heal plugin that uses OpenAI, Anthropic, or local models to repair failing steps and propose locator fixes.
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,152 | 🐛 45 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,603 | 🐛 514 | 🌐 Kotlin | 📅 2026-09-13 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,180 | 🐛 578 | 🌐 JavaScript | 📅 2026-09-08 🆓 - Visual regression testing for responsive web UIs.
...
* [Reg-Suit](https://github.com/reg-viz/reg-suit) ⭐ 1,292 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-09 🆓 - Visual regression testing workflow with publish/notify integrations for CI.
* [Argos](https://github.com/argos-ci/argos) ⭐ 625 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,871 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-12 🆓 - AI-driven UI automation with natural language commands.
...
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 4,454 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-13 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
* [Passmark](https://github.com/bug0inc/passmark) ⭐ 1,264 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-12 🆓 - Open-source AI regression testing framework on Playwright with intelligent caching, auto-healing, and multi-model verification.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,544 | 🐛 925 | 🌐 TypeScript | 📅 2026-09-13 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,062 | 🐛 652 | 🌐 TypeScript | 📅 2026-09-13 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,996 | 🐛 250 | 🌐 Python | 📅 2026-09-13 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,444 | 🐛 338 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 18,249 | 🐛 583 | 🌐 Python | 📅 2026-09-13 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,722 | 🐛 588 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,963 | 🐛 978 | 🌐 Python | 📅 2026-09-10 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,441 | 🐛 976 | 🌐 Python | 📅 2026-09-13 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,912 | 🐛 303 | 🌐 Jupyter Notebook | 📅 2026-09-11 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,153 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-11 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 4,766 | 🐛 945 | 🌐 TypeScript | 📅 2026-09-13 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,547 | 🐛 63 | 🌐 Python | 📅 2026-09-12 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,762 | 🐛 304 | 🌐 Python | 📅 2026-09-13 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,128 | 🐛 223 | 🌐 Python | 📅 2026-09-12 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 131 | 🐛 7 | 🌐 Rust | 📅 2026-09-11 🆓 - Local-first TUI and CLI for evaluating AI coding agent sessions with cost, token, latency, and failure regression gates.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,114 | 🐛 109 | 🌐 TypeScript | 📅 2026-09-13 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,489 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-13 🆓 - Standard fake data library, often paired with AI for context-aware data.
* [Datafaker](https://github.com/datafaker-net/datafaker) ⭐ 1,794 | 🐛 13 | 🌐 Java | 📅 2026-09-12 🆓 - Java/Kotlin port of Faker for realistic fake data generation in JVM-based test suites.
...
* [MSW (Mock Service Worker)](https://github.com/mswjs/msw) ⭐ 18,204 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-10 🆓 - API mocking library for browser and Node.js, ideal for frontend AI testing.
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,399 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-13 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,372 | 🐛 505 | 🌐 Java | 📅 2026-09-11 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,461 | 🐛 804 | 🌐 Go | 📅 2026-09-13 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,453 | 🐛 727 | 🌐 Go | 📅 2026-09-13 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,226 | 🐛 428 | 🌐 Python | 📅 2026-09-09 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,406 | 🐛 82 | 🌐 Python | 📅 2026-09-13 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,112 | 🐛 232 | 🌐 Python | 📅 2026-09-11 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,813 | 🐛 65 | 🌐 Python | 📅 2026-09-09 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,793 | 🐛 64 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 114,488 | 🐛 407 | 🌐 Python | 📅 2026-09-13 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 35,323 | 🐛 95 | 🌐 Zig | 📅 2026-09-13 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,268 | 🐛 372 | 🌐 TypeScript | 📅 2026-09-11 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,991 | 🐛 237 | 🌐 Python | 📅 2026-09-13 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,638 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-03 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,572 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-13 🆓 - Patched Playwright for stealth automation.
* [Notte](https://github.com/nottelabs/notte) ⭐ 2,002 | 🐛 15 | 🌐 Python | 📅 2026-09-13 🆓 - Web agent framework for building fast, cost-efficient AI agents that automate web interactions using natural language instructions, with browser session management, structured data extraction, and anti-detection support.
* [AgentQL](https://github.com/tinyfish-io/agentql) ⭐ 1,462 | 🐛 10 | 🌐 Python | 📅 2026-08-26 🆓💰 - Natural language query language for AI agents to interact with and extract structured data from web pages, with self-healing selectors that integrate with Playwright.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,833 | 🐛 12 | 🌐 Python | 📅 2026-09-02 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,728 | 🐛 77 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,376 | 🐛 45 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,140 | 🐛 204 | 🌐 Python | 📅 2026-08-30 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
* [HELM](https://github.com/stanford-crfm/helm) ⭐ 2,907 | 🐛 105 | 🌐 Python | 📅 2026-09-01 🆓 - Stanford CRFM's open-source Python framework for holistic, reproducible, and transparent evaluation of LLMs and multimodal models across dozens of scenarios covering accuracy, robustness, efficiency, bias, and safety.
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,608 | 🐛 103 | 🌐 Python | 📅 2025-11-26 - Self-hostable web environment for building and evaluating autonomous agents on realistic, multi-site tasks.
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,433 | 🐛 53 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
* [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐ 941 | 🐛 45 | 🌐 Python | 📅 2025-07-16 🆓 - Contamination-free holistic benchmark for evaluating LLM coding abilities that continuously collects problems from LeetCode, AtCoder, and CodeForces, covering code generation, execution, and test output prediction.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,157 | 🐛 137 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,694 | 🐛 216 | 📅 2025-08-20 - LLM security tools and resources.
