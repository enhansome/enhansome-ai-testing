...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 778 | 🐛 53 | 🌐 Kotlin | 📅 2026-08-29 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 50,153 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-28 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,604 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-28 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 12,952 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-27 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
...
* [CodeceptJS](https://github.com/codeceptjs/CodeceptJS) ⭐ 4,243 | 🐛 220 | 🌐 JavaScript | 📅 2026-08-24 🆓 - End-to-end testing framework with built-in AI heal plugin that uses OpenAI, Anthropic, or local models to repair failing steps and propose locator fixes.
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,134 | 🐛 37 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 933 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 🆓 - Self-improving QA agent for natural-language web and mobile tests with run memory, UI-change adaptation, and regression detection.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,454 | 🐛 496 | 🌐 Kotlin | 📅 2026-08-28 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [Argos](https://github.com/argos-ci/argos) ⭐ 617 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-29 🆓💰 - Open source visual testing for engineering teams.
...
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 1,527 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-29 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
* [Passmark](https://github.com/bug0inc/passmark) ⭐ 1,255 | 🐛 37 | 🌐 TypeScript | 📅 2026-07-30 🆓 - Open-source AI regression testing framework on Playwright with intelligent caching, auto-healing, and multi-model verification.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,907 | 🐛 861 | 🌐 TypeScript | 📅 2026-08-29 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,664 | 🐛 547 | 🌐 TypeScript | 📅 2026-08-29 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,667 | 🐛 214 | 🌐 Python | 📅 2026-08-29 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
...
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 17,953 | 🐛 494 | 🌐 Python | 📅 2026-08-29 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,540 | 🐛 579 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,827 | 🐛 915 | 🌐 Python | 📅 2026-08-29 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,243 | 🐛 923 | 🌐 Python | 📅 2026-08-29 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,863 | 🐛 299 | 🌐 Jupyter Notebook | 📅 2026-08-05 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,116 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-26 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,529 | 🐛 61 | 🌐 Python | 📅 2026-08-28 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,517 | 🐛 820 | 🌐 TypeScript | 📅 2026-08-29 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,661 | 🐛 298 | 🌐 Python | 📅 2026-08-29 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,122 | 🐛 223 | 🌐 Python | 📅 2026-08-28 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,060 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-28 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,476 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-29 🆓 - Standard fake data library, often paired with AI for context-aware data.
...
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,382 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-28 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,350 | 🐛 495 | 🌐 Java | 📅 2026-08-28 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,350 | 🐛 799 | 🌐 Go | 📅 2026-08-29 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Pa11y](https://github.com/pa11y/pa11y) ⭐ 4,492 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-28 🆓 - Open-source automated accessibility testing tool.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,436 | 🐛 714 | 🌐 Go | 📅 2026-08-29 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,071 | 🐛 409 | 🌐 Python | 📅 2026-08-25 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,334 | 🐛 84 | 🌐 Python | 📅 2026-08-27 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,027 | 🐛 204 | 🌐 Python | 📅 2026-08-27 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,792 | 🐛 63 | 🌐 Python | 📅 2026-08-28 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,635 | 🐛 61 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 111,658 | 🐛 392 | 🌐 Python | 📅 2026-08-29 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 34,309 | 🐛 101 | 🌐 Zig | 📅 2026-08-29 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,094 | 🐛 344 | 🌐 TypeScript | 📅 2026-08-29 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,877 | 🐛 221 | 🌐 Python | 📅 2026-08-29 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,560 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-25 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,219 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-29 🆓 - Patched Playwright for stealth automation.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,734 | 🐛 17 | 🌐 Python | 📅 2026-08-18 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
...
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,356 | 🐛 45 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,112 | 🐛 202 | 🌐 Python | 📅 2026-08-21 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
...
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,687 | 🐛 198 | 📅 2025-08-20 - LLM security tools and resources.
* [awesome-mutation-testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 469 | 🐛 2 | 📅 2026-08-27 - Mutation testing resources.
* [awesome-testing-tools](https://github.com/ZoranPandovski/awesome-testing-tools) ⭐ 370 | 🐛 32 | 🌐 CSS | 📅 2026-08-27 - General testing tools.
