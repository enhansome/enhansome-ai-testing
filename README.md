...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 775 | 🐛 47 | 🌐 Kotlin | 📅 2026-08-24 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 49,641 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-24 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,423 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-21 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 12,813 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-19 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,418 | 🐛 498 | 🌐 Kotlin | 📅 2026-08-24 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [Argos](https://github.com/argos-ci/argos) ⭐ 615 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-24 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,661 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-24 🆓 - AI-driven UI automation with natural language commands.
...
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 1,504 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-23 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,631 | 🐛 824 | 🌐 TypeScript | 📅 2026-08-24 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,527 | 🐛 525 | 🌐 TypeScript | 📅 2026-08-24 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,569 | 🐛 219 | 🌐 Python | 📅 2026-08-24 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,240 | 🐛 323 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 17,818 | 🐛 471 | 🌐 Python | 📅 2026-08-21 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,450 | 🐛 571 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,773 | 🐛 941 | 🌐 Python | 📅 2026-08-24 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,168 | 🐛 930 | 🌐 Python | 📅 2026-08-24 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,840 | 🐛 298 | 🌐 Jupyter Notebook | 📅 2026-08-05 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,097 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-23 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,520 | 🐛 66 | 🌐 Python | 📅 2026-08-21 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,505 | 🐛 812 | 🌐 TypeScript | 📅 2026-08-24 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,611 | 🐛 293 | 🌐 Python | 📅 2026-08-23 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,121 | 🐛 228 | 🌐 Python | 📅 2026-08-24 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,043 | 🐛 92 | 🌐 TypeScript | 📅 2026-08-24 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [MSW (Mock Service Worker)](https://github.com/mswjs/msw) ⭐ 18,155 | 🐛 41 | 🌐 TypeScript | 📅 2026-07-24 🆓 - API mocking library for browser and Node.js, ideal for frontend AI testing.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,303 | 🐛 795 | 🌐 Go | 📅 2026-08-24 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,415 | 🐛 704 | 🌐 Go | 📅 2026-08-24 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,006 | 🐛 405 | 🌐 Python | 📅 2026-08-21 🆓 - LLM vulnerability scanner from NVIDIA.
...
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,008 | 🐛 214 | 🌐 Python | 📅 2026-08-24 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,614 | 🐛 59 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 110,331 | 🐛 380 | 🌐 Python | 📅 2026-08-22 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 34,220 | 🐛 97 | 🌐 Zig | 📅 2026-08-24 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,041 | 🐛 331 | 🌐 TypeScript | 📅 2026-08-22 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,842 | 🐛 218 | 🌐 Python | 📅 2026-08-24 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,534 | 🐛 63 | 🌐 TypeScript | 📅 2026-08-19 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,159 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-19 🆓 - Patched Playwright for stealth automation.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,144 | 🐛 128 | 📅 2025-11-28 - General test automation across languages.
