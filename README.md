...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,629 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 778 | 🐛 53 | 🌐 Kotlin | 📅 2026-09-01 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 50,400 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-01 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,707 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 13,012 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-01 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
...
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 7,040 | 🐛 148 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,141 | 🐛 38 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 897 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 🆓 - Self-improving QA agent for natural-language web and mobile tests with run memory, UI-change adaptation, and regression detection.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,474 | 🐛 496 | 🌐 Kotlin | 📅 2026-09-01 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [Pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,936 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 🆓 - Pixel-level image comparison library.
...
* [Reg-Suit](https://github.com/reg-viz/reg-suit) ⭐ 1,288 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-26 🆓 - Visual regression testing workflow with publish/notify integrations for CI.
* [Argos](https://github.com/argos-ci/argos) ⭐ 619 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-31 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,757 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-01 🆓 - AI-driven UI automation with natural language commands.
...
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 1,562 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-01 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
* [Passmark](https://github.com/bug0inc/passmark) ⭐ 1,257 | 🐛 37 | 🌐 TypeScript | 📅 2026-07-30 🆓 - Open-source AI regression testing framework on Playwright with intelligent caching, auto-healing, and multi-model verification.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,052 | 🐛 874 | 🌐 TypeScript | 📅 2026-09-01 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,733 | 🐛 565 | 🌐 TypeScript | 📅 2026-09-01 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,731 | 🐛 234 | 🌐 Python | 📅 2026-09-01 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,355 | 🐛 327 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 18,033 | 🐛 551 | 🌐 Python | 📅 2026-09-01 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,575 | 🐛 581 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,858 | 🐛 918 | 🌐 Python | 📅 2026-09-01 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,282 | 🐛 944 | 🌐 Python | 📅 2026-09-01 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,875 | 🐛 300 | 🌐 Jupyter Notebook | 📅 2026-08-31 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,122 | 🐛 154 | 🌐 TypeScript | 📅 2026-08-31 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,531 | 🐛 62 | 🌐 Python | 📅 2026-09-01 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,522 | 🐛 842 | 🌐 TypeScript | 📅 2026-09-01 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,682 | 🐛 261 | 🌐 Python | 📅 2026-09-01 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,123 | 🐛 222 | 🌐 Python | 📅 2026-09-01 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,071 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-01 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,477 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-01 🆓 - Standard fake data library, often paired with AI for context-aware data.
...
* [MSW (Mock Service Worker)](https://github.com/mswjs/msw) ⭐ 18,177 | 🐛 41 | 🌐 TypeScript | 📅 2026-07-24 🆓 - API mocking library for browser and Node.js, ideal for frontend AI testing.
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,387 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-01 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,353 | 🐛 496 | 🌐 Java | 📅 2026-09-01 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
* [Hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,510 | 🐛 33 | 🌐 Go | 📅 2026-08-28 🆓 - Lightweight service virtualization with proxy-based recording and replay.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,365 | 🐛 801 | 🌐 Go | 📅 2026-08-31 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Pa11y](https://github.com/pa11y/pa11y) ⭐ 4,493 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-28 🆓 - Open-source automated accessibility testing tool.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,436 | 🐛 717 | 🌐 Go | 📅 2026-09-01 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,091 | 🐛 412 | 🌐 Python | 📅 2026-08-25 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,341 | 🐛 82 | 🌐 Python | 📅 2026-09-01 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,043 | 🐛 213 | 🌐 Python | 📅 2026-09-01 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,800 | 🐛 60 | 🌐 Python | 📅 2026-09-01 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,649 | 🐛 59 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 111,965 | 🐛 399 | 🌐 Python | 📅 2026-09-01 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 34,365 | 🐛 108 | 🌐 Zig | 📅 2026-09-01 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,122 | 🐛 349 | 🌐 TypeScript | 📅 2026-09-01 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,903 | 🐛 216 | 🌐 Python | 📅 2026-09-01 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,578 | 🐛 66 | 🌐 TypeScript | 📅 2026-08-25 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,241 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-29 🆓 - Patched Playwright for stealth automation.
* [Notte](https://github.com/nottelabs/notte) ⭐ 1,999 | 🐛 11 | 🌐 Python | 📅 2026-09-01 🆓 - Web agent framework for building fast, cost-efficient AI agents that automate web interactions using natural language instructions, with browser session management, structured data extraction, and anti-detection support.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,758 | 🐛 8 | 🌐 Python | 📅 2026-09-01 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,709 | 🐛 76 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,360 | 🐛 45 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,117 | 🐛 201 | 🌐 Python | 📅 2026-08-30 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
* [HELM](https://github.com/stanford-crfm/helm) ⭐ 2,897 | 🐛 100 | 🌐 Python | 📅 2026-09-01 🆓 - Stanford CRFM's open-source Python framework for holistic, reproducible, and transparent evaluation of LLMs and multimodal models across dozens of scenarios covering accuracy, robustness, efficiency, bias, and safety.
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,591 | 🐛 102 | 🌐 Python | 📅 2025-11-26 - Self-hostable web environment for building and evaluating autonomous agents on realistic, multi-site tasks.
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,415 | 🐛 52 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,150 | 🐛 135 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,689 | 🐛 202 | 📅 2025-08-20 - LLM security tools and resources.
