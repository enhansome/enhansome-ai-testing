...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,612 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 49,260 | 🐛 113 | 🌐 TypeScript | 📅 2026-08-16 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,183 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-12 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 12,555 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-13 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
...
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 6,972 | 🐛 146 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,115 | 🐛 36 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 847 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 🆓 - Self-improving QA agent for natural-language web and mobile tests with run memory, UI-change adaptation, and regression detection.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,345 | 🐛 494 | 🌐 Kotlin | 📅 2026-08-15 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [Pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,914 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 🆓 - Pixel-level image comparison library.
...
* [Argos](https://github.com/argos-ci/argos) ⭐ 611 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-16 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,582 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-16 🆓 - AI-driven UI automation with natural language commands.
...
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 944 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-16 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,192 | 🐛 778 | 🌐 TypeScript | 📅 2026-08-16 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,276 | 🐛 505 | 🌐 TypeScript | 📅 2026-08-16 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,415 | 🐛 197 | 🌐 Python | 📅 2026-08-14 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,181 | 🐛 225 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 17,619 | 🐛 462 | 🌐 Python | 📅 2026-08-13 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,330 | 🐛 559 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,665 | 🐛 934 | 🌐 Python | 📅 2026-08-14 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,072 | 🐛 924 | 🌐 Python | 📅 2026-08-16 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,811 | 🐛 298 | 🌐 Jupyter Notebook | 📅 2026-08-05 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,072 | 🐛 169 | 🌐 TypeScript | 📅 2026-07-25 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,511 | 🐛 53 | 🌐 Python | 📅 2026-08-14 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,492 | 🐛 841 | 🌐 TypeScript | 📅 2026-08-16 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,559 | 🐛 268 | 🌐 Python | 📅 2026-08-15 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,118 | 🐛 244 | 🌐 Python | 📅 2026-08-15 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,016 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-15 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,450 | 🐛 101 | 🌐 TypeScript | 📅 2026-08-16 🆓 - Standard fake data library, often paired with AI for context-aware data.
...
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,364 | 🐛 48 | 🌐 TypeScript | 📅 2026-08-14 🆓 - GUI-based open source API mocking tool, easy to set up.
...
* [Hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,508 | 🐛 33 | 🌐 Go | 📅 2026-08-05 🆓 - Lightweight service virtualization with proxy-based recording and replay.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,267 | 🐛 784 | 🌐 Go | 📅 2026-08-16 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,401 | 🐛 704 | 🌐 Go | 📅 2026-08-16 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 8,827 | 🐛 389 | 🌐 Python | 📅 2026-08-14 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,290 | 🐛 84 | 🌐 Python | 📅 2026-08-14 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,962 | 🐛 217 | 🌐 Python | 📅 2026-08-15 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,754 | 🐛 61 | 🌐 Python | 📅 2026-08-14 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,451 | 🐛 55 | 🌐 Python | 📅 2026-08-12 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,423 | 🐛 354 | 🌐 Python | 📅 2026-08-16 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 33,936 | 🐛 87 | 🌐 Zig | 📅 2026-08-16 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 23,955 | 🐛 320 | 🌐 TypeScript | 📅 2026-08-16 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,761 | 🐛 215 | 🌐 Python | 📅 2026-08-16 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,494 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-05 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,103 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-16 🆓 - Patched Playwright for stealth automation.
* [AgentQL](https://github.com/tinyfish-io/agentql) ⭐ 1,450 | 🐛 9 | 🌐 Python | 📅 2026-08-09 🆓💰 - Natural language query language for AI agents to interact with and extract structured data from web pages, with self-healing selectors that integrate with Playwright.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,647 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,670 | 🐛 75 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,336 | 🐛 44 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
...
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,384 | 🐛 51 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,132 | 🐛 127 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,683 | 🐛 184 | 📅 2025-08-20 - LLM security tools and resources.
...
* [awesome-ai-pentest](https://github.com/insidetrust/awesome-ai-pentest) ⭐ 26 | 🐛 1 | 📅 2026-02-20 - AI-assisted penetration testing.
