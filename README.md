...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,606 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 772 | 🐛 46 | 🌐 Kotlin | 📅 2026-08-14 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 49,171 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-14 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,125 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-12 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 12,513 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-13 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
* [BrowserTools MCP](https://github.com/AgentDeskAI/browser-tools-mcp) ⭐ 7,292 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12 🆓 - Browser monitoring and console log access for AI agents via Chrome extension.
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 6,965 | 🐛 146 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
...
* [CodeceptJS](https://github.com/codeceptjs/CodeceptJS) ⭐ 4,240 | 🐛 216 | 🌐 JavaScript | 📅 2026-08-14 🆓 - End-to-end testing framework with built-in AI heal plugin that uses OpenAI, Anthropic, or local models to repair failing steps and propose locator fixes.
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,115 | 🐛 35 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 675 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 🆓 - Self-improving QA agent for natural-language web and mobile tests with run memory, UI-change adaptation, and regression detection.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,329 | 🐛 495 | 🌐 Kotlin | 📅 2026-08-14 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,170 | 🐛 578 | 🌐 JavaScript | 📅 2024-09-07 🆓 - Visual regression testing for responsive web UIs.
...
* [Argos](https://github.com/argos-ci/argos) ⭐ 611 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-14 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,573 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-14 🆓 - AI-driven UI automation with natural language commands.
* [Shortest](https://github.com/anti-work/shortest) ⭐ 5,664 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-06 🆓 - QA via natural language AI tests, built on Playwright.
* [Passmark](https://github.com/bug0inc/passmark) ⭐ 1,249 | 🐛 34 | 🌐 TypeScript | 📅 2026-07-30 🆓 - Open-source AI regression testing framework on Playwright with intelligent caching, auto-healing, and multi-model verification.
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 939 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-14 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 33,109 | 🐛 777 | 🌐 TypeScript | 📅 2026-08-14 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,235 | 🐛 497 | 🌐 TypeScript | 📅 2026-08-14 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,388 | 🐛 193 | 🌐 Python | 📅 2026-08-14 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,171 | 🐛 225 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 17,597 | 🐛 463 | 🌐 Python | 📅 2026-08-13 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,313 | 🐛 555 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,632 | 🐛 927 | 🌐 Python | 📅 2026-08-14 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,052 | 🐛 921 | 🌐 Python | 📅 2026-08-14 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,808 | 🐛 297 | 🌐 Jupyter Notebook | 📅 2026-08-05 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,069 | 🐛 166 | 🌐 TypeScript | 📅 2026-07-25 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,508 | 🐛 42 | 🌐 Python | 📅 2026-08-14 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,491 | 🐛 844 | 🌐 TypeScript | 📅 2026-08-14 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,549 | 🐛 267 | 🌐 Python | 📅 2026-08-14 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,116 | 🐛 245 | 🌐 Python | 📅 2026-08-14 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [ReportPortal](https://github.com/reportportal/reportportal) ⭐ 2,017 | 🐛 450 | 🌐 Makefile | 📅 2026-08-14 🆓💰 - Open source results management with ML-based failure clustering.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,010 | 🐛 85 | 🌐 TypeScript | 📅 2026-08-14 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,450 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-14 🆓 - Standard fake data library, often paired with AI for context-aware data.
...
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,357 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-09 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,335 | 🐛 504 | 🌐 Java | 📅 2026-08-14 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,259 | 🐛 777 | 🌐 Go | 📅 2026-08-14 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Pa11y](https://github.com/pa11y/pa11y) ⭐ 4,486 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-10 🆓 - Open-source automated accessibility testing tool.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 8,800 | 🐛 390 | 🌐 Python | 📅 2026-08-13 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,285 | 🐛 82 | 🌐 Python | 📅 2026-08-14 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 6,951 | 🐛 215 | 🌐 Python | 📅 2026-08-13 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,749 | 🐛 61 | 🌐 Python | 📅 2026-08-14 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,445 | 🐛 55 | 🌐 Python | 📅 2026-08-12 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,225 | 🐛 353 | 🌐 Python | 📅 2026-08-13 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 33,891 | 🐛 87 | 🌐 Zig | 📅 2026-08-14 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 23,940 | 🐛 297 | 🌐 TypeScript | 📅 2026-08-14 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,752 | 🐛 214 | 🌐 Python | 📅 2026-08-14 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,481 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-05 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,089 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-05 🆓 - Patched Playwright for stealth automation.
* [AgentQL](https://github.com/tinyfish-io/agentql) ⭐ 1,448 | 🐛 9 | 🌐 Python | 📅 2026-08-09 🆓💰 - Natural language query language for AI agents to interact with and extract structured data from web pages, with self-healing selectors that integrate with Playwright.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,637 | 🐛 3 | 🌐 Python | 📅 2026-08-14 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,668 | 🐛 74 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,333 | 🐛 44 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,081 | 🐛 189 | 🌐 Python | 📅 2026-08-12 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
* [HELM](https://github.com/stanford-crfm/helm) ⭐ 2,878 | 🐛 91 | 🌐 Python | 📅 2026-08-01 🆓 - Stanford CRFM's open-source Python framework for holistic, reproducible, and transparent evaluation of LLMs and multimodal models across dozens of scenarios covering accuracy, robustness, efficiency, bias, and safety.
...
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,381 | 🐛 51 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,130 | 🐛 126 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,681 | 🐛 180 | 📅 2025-08-20 - LLM security tools and resources.
* [awesome-mutation-testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 467 | 🐛 2 | 📅 2026-08-06 - Mutation testing resources.
* [awesome-testing-tools](https://github.com/ZoranPandovski/awesome-testing-tools) ⭐ 364 | 🐛 29 | 🌐 CSS | 📅 2026-06-19 - General testing tools.
...
* [awesome-ai-pentest](https://github.com/insidetrust/awesome-ai-pentest) ⭐ 25 | 🐛 1 | 📅 2026-02-20 - AI-assisted penetration testing.
