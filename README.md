...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,648 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 781 | 🐛 54 | 🌐 Kotlin | 📅 2026-09-18 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 52,276 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-18 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 37,256 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-18 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 13,387 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-14 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
...
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 7,109 | 🐛 150 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
* [ExecuteAutomation Playwright MCP](https://github.com/executeautomation/mcp-playwright) ⭐ 5,648 | 🐛 37 | 🌐 TypeScript | 📅 2025-12-13 🆓 - Community Playwright MCP server with API testing support and 143 device emulation profiles.
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,162 | 🐛 44 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
* [agent-qa](https://github.com/vostride/agent-qa) ⭐ 884 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 🆓 - Self-improving QA agent for natural-language web and mobile tests with run memory, UI-change adaptation, and regression detection.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,675 | 🐛 521 | 🌐 Kotlin | 📅 2026-09-18 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [Pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,951 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-15 🆓 - Pixel-level image comparison library.
...
* [Argos](https://github.com/argos-ci/argos) ⭐ 629 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-17 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,939 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-18 🆓 - AI-driven UI automation with natural language commands.
* [Shortest](https://github.com/anti-work/shortest) ⭐ 5,677 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-06 🆓 - QA via natural language AI tests, built on Playwright.
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 4,637 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-18 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
* [Passmark](https://github.com/bug0inc/passmark) ⭐ 1,270 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-12 🆓 - Open-source AI regression testing framework on Playwright with intelligent caching, auto-healing, and multi-model verification.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,786 | 🐛 920 | 🌐 TypeScript | 📅 2026-09-18 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,267 | 🐛 637 | 🌐 TypeScript | 📅 2026-09-18 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,126 | 🐛 290 | 🌐 Python | 📅 2026-09-18 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,475 | 🐛 340 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 18,330 | 🐛 614 | 🌐 Python | 📅 2026-09-18 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,766 | 🐛 596 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 14,018 | 🐛 995 | 🌐 Python | 📅 2026-09-14 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,536 | 🐛 1,017 | 🌐 Python | 📅 2026-09-18 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,926 | 🐛 308 | 🌐 Jupyter Notebook | 📅 2026-09-11 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,164 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-16 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 4,815 | 🐛 1,002 | 🌐 TypeScript | 📅 2026-09-18 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,562 | 🐛 67 | 🌐 Python | 📅 2026-09-18 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,807 | 🐛 320 | 🌐 Python | 📅 2026-09-18 🆓 - LLM evaluation framework from the UK AI Safety Institute.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,135 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-16 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,490 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-15 🆓 - Standard fake data library, often paired with AI for context-aware data.
* [Datafaker](https://github.com/datafaker-net/datafaker) ⭐ 1,796 | 🐛 13 | 🌐 Java | 📅 2026-09-17 🆓 - Java/Kotlin port of Faker for realistic fake data generation in JVM-based test suites.
...
* [MSW (Mock Service Worker)](https://github.com/mswjs/msw) ⭐ 18,210 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-18 🆓 - API mocking library for browser and Node.js, ideal for frontend AI testing.
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,414 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-16 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,376 | 🐛 502 | 🌐 Java | 📅 2026-09-18 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
* [Hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,516 | 🐛 34 | 🌐 Go | 📅 2026-09-13 🆓 - Lightweight service virtualization with proxy-based recording and replay.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,521 | 🐛 805 | 🌐 Go | 📅 2026-09-18 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Pa11y](https://github.com/pa11y/pa11y) ⭐ 4,532 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 🆓 - Open-source automated accessibility testing tool.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,467 | 🐛 734 | 🌐 Go | 📅 2026-09-17 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,298 | 🐛 448 | 🌐 Python | 📅 2026-09-16 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,434 | 🐛 82 | 🌐 Python | 📅 2026-09-18 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,166 | 🐛 232 | 🌐 Python | 📅 2026-09-18 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,825 | 🐛 66 | 🌐 Python | 📅 2026-09-18 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,832 | 🐛 70 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 115,146 | 🐛 444 | 🌐 Python | 📅 2026-09-15 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 35,421 | 🐛 81 | 🌐 Zig | 📅 2026-09-18 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,348 | 🐛 396 | 🌐 TypeScript | 📅 2026-09-18 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 23,032 | 🐛 246 | 🌐 Python | 📅 2026-09-18 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,664 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-16 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,626 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-13 🆓 - Patched Playwright for stealth automation.
* [Notte](https://github.com/nottelabs/notte) ⭐ 2,002 | 🐛 16 | 🌐 Python | 📅 2026-09-18 🆓 - Web agent framework for building fast, cost-efficient AI agents that automate web interactions using natural language instructions, with browser session management, structured data extraction, and anti-detection support.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,870 | 🐛 13 | 🌐 Python | 📅 2026-09-18 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,741 | 🐛 77 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,381 | 🐛 45 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,148 | 🐛 202 | 🌐 Python | 📅 2026-09-14 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
* [HELM](https://github.com/stanford-crfm/helm) ⭐ 2,914 | 🐛 105 | 🌐 Python | 📅 2026-09-01 🆓 - Stanford CRFM's open-source Python framework for holistic, reproducible, and transparent evaluation of LLMs and multimodal models across dozens of scenarios covering accuracy, robustness, efficiency, bias, and safety.
...
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,441 | 🐛 54 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,167 | 🐛 140 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,700 | 🐛 226 | 📅 2025-08-20 - LLM security tools and resources.
...
* [awesome-ai-pentest](https://github.com/insidetrust/awesome-ai-pentest) ⭐ 35 | 🐛 2 | 📅 2026-02-20 - AI-assisted penetration testing.
