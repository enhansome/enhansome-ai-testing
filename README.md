...
* [Qodo-Cover](https://github.com/qodo-ai/qodo-cover) ⭐ 5,636 | 🐛 37 | 🌐 Python | 📅 2026-04-05 🆓 - AI-powered tool for automated test generation and code coverage enhancement.
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,383 | 🐛 8 | 🌐 Python | 📅 2026-09-03 🆓 - Automated unit test generation for Python via evolutionary algorithms, from Saarland University.
...
* [EvoMaster](https://github.com/EMResearch/EvoMaster) ⭐ 779 | 🐛 52 | 🌐 Kotlin | 📅 2026-09-05 🆓 - First open source AI tool that automatically generates test cases via evolutionary algorithms for REST, GraphQL, and RPC APIs.
...
* [Chrome DevTools MCP](https://github.com/ChromeDevTools/chrome-devtools-mcp) ⭐ 51,151 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-06 🆓 - Official MCP server from the Chrome DevTools team, with 26 tools for browser automation, debugging, and performance analysis.
* [Playwright MCP](https://github.com/microsoft/playwright-mcp) ⭐ 36,856 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-04 🆓 - Official Playwright MCP server giving AI agents full browser control through structured accessibility snapshots.
* [Playwright CLI](https://github.com/microsoft/playwright-cli) ⭐ 13,116 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03 🆓 - Token-efficient CLI for coding agents like Claude Code and GitHub Copilot, with installable skills.
* [BrowserTools MCP](https://github.com/AgentDeskAI/browser-tools-mcp) ⭐ 7,313 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12 🆓 - Browser monitoring and console log access for AI agents via Chrome extension.
* [Browser MCP](https://github.com/browsermcp/mcp) ⭐ 7,050 | 🐛 146 | 🌐 TypeScript | 📅 2025-04-24 🆓 - Popular MCP server that automates the user's own local browser, preserving logged-in sessions and avoiding bot detection. Note: limited maintenance activity since mid-2025 but widely used (6.5k+ stars).
...
* [CodeceptJS](https://github.com/codeceptjs/CodeceptJS) ⭐ 4,243 | 🐛 221 | 🌐 JavaScript | 📅 2026-09-05 🆓 - End-to-end testing framework with built-in AI heal plugin that uses OpenAI, Anthropic, or local models to repair failing steps and propose locator fixes.
...
* [TestZeus Hercules](https://github.com/test-zeus-ai/testzeus-hercules) ⭐ 1,147 | 🐛 39 | 🌐 Python | 📅 2026-08-04 🆓 - World's first open-source testing agent for UI, API, security, accessibility, and visual validations, no code required.
...
* [Maestro](https://github.com/mobile-dev-inc/maestro) ⭐ 15,519 | 🐛 503 | 🌐 Kotlin | 📅 2026-09-06 🆓💰 - YAML-based mobile UI automation that reads accessibility tree, no XPath needed.
...
* [BackstopJS](https://github.com/garris/BackstopJS) ⭐ 7,175 | 🐛 578 | 🌐 JavaScript | 📅 2024-09-07 🆓 - Visual regression testing for responsive web UIs.
* [Pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,940 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 🆓 - Pixel-level image comparison library.
...
* [Reg-Suit](https://github.com/reg-viz/reg-suit) ⭐ 1,291 | 🐛 72 | 🌐 TypeScript | 📅 2026-09-03 🆓 - Visual regression testing workflow with publish/notify integrations for CI.
* [Argos](https://github.com/argos-ci/argos) ⭐ 620 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05 🆓💰 - Open source visual testing for engineering teams.
...
* [Midscene.js](https://github.com/web-infra-dev/midscene) ⭐ 14,794 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-06 🆓 - AI-driven UI automation with natural language commands.
* [Shortest](https://github.com/anti-work/shortest) ⭐ 5,671 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-06 🆓 - QA via natural language AI tests, built on Playwright.
* [Magnitude](https://github.com/magnitudedev/magnitude) ⭐ 3,617 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-06 🆓 - AI-native, vision-first testing framework that lets you write E2E tests in plain language.
* [Passmark](https://github.com/bug0inc/passmark) ⭐ 1,259 | 🐛 37 | 🌐 TypeScript | 📅 2026-07-30 🆓 - Open-source AI regression testing framework on Playwright with intelligent caching, auto-healing, and multi-model verification.
...
* [Langfuse](https://github.com/langfuse/langfuse) ⭐ 34,257 | 🐛 911 | 🌐 TypeScript | 📅 2026-09-06 🆓💰 - Open source LLM observability, tracing, and evaluation platform.
* [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,864 | 🐛 587 | 🌐 TypeScript | 📅 2026-09-06 🆓💰 - Test framework with LLM-as-judge for prompts, models, and RAG pipelines.
* [Opik](https://github.com/comet-ml/opik) ⭐ 21,833 | 🐛 265 | 🌐 Python | 📅 2026-09-06 🆓💰 - Open-source LLM evaluation and observability platform with automated tracing, LLM-as-judge metrics, and pytest integration for CI pipelines.
* [OpenAI Evals](https://github.com/openai/evals) ⭐ 19,395 | 🐛 333 | 🌐 Python | 📅 2026-04-14 🆓 - Framework for evaluating LLMs and an open-source registry of benchmarks from OpenAI. No longer actively maintained for new evals, but still widely used as a reference.
* [DeepEval](https://github.com/confident-ai/deepeval) ⭐ 18,127 | 🐛 571 | 🌐 Python | 📅 2026-09-06 🆓💰 - Pytest-like LLM evaluation framework with built-in judge metrics.
* [Ragas](https://github.com/explodinggradients/ragas) ⭐ 15,635 | 🐛 592 | 🌐 Python | 📅 2026-02-24 🆓 - Evaluation framework for RAG pipelines using LLM judges.
* [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐ 13,906 | 🐛 945 | 🌐 Python | 📅 2026-09-01 🆓 - EleutherAI's framework for few-shot evaluation of language models, backing the Hugging Face Open LLM Leaderboard.
* [Arize Phoenix](https://github.com/Arize-ai/phoenix) ⭐ 11,345 | 🐛 979 | 🌐 Python | 📅 2026-09-06 🆓 - Open-source LLM observability and evaluation.
* [Evidently](https://github.com/evidentlyai/evidently) ⭐ 7,894 | 🐛 302 | 🌐 Jupyter Notebook | 📅 2026-08-31 🆓💰 - Open-source Python library for evaluating, testing, and monitoring ML and LLM systems with 100+ built-in metrics for data quality, drift detection, and LLM output quality.
* [Helicone](https://github.com/Helicone/helicone) ⭐ 6,133 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-31 🆓💰 - Open source LLM observability and prompt evaluation platform.
* [TruLens](https://github.com/truera/trulens) ⭐ 3,536 | 🐛 64 | 🌐 Python | 📅 2026-09-04 🆓 - Evaluation framework for LLM apps with feedback functions and tracing.
* [LangWatch](https://github.com/langwatch/langwatch) ⭐ 3,524 | 🐛 914 | 🌐 TypeScript | 📅 2026-09-06 🆓💰 - Open-source LLM evaluation and AI agent testing platform combining end-to-end scenario simulation, observability, and prompt management in a single unified loop.
* [Inspect AI](https://github.com/UKGovernmentBEIS/inspect_ai) ⭐ 2,714 | 🐛 274 | 🌐 Python | 📅 2026-09-06 🆓 - LLM evaluation framework from the UK AI Safety Institute.
* [Weights & Biases Weave](https://github.com/wandb/weave) ⭐ 1,125 | 🐛 220 | 🌐 Python | 📅 2026-09-04 🆓💰 - Weights & Biases toolkit for tracing, debugging, and evaluating generative AI applications with built-in LLM-as-judge metrics and dataset management.
...
* [ReportPortal](https://github.com/reportportal/reportportal) ⭐ 2,026 | 🐛 449 | 🌐 Makefile | 📅 2026-08-20 🆓💰 - Open source results management with ML-based failure clustering.
* [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 130 | 🐛 7 | 🌐 Rust | 📅 2026-09-06 🆓 - Local-first TUI and CLI for evaluating AI coding agent sessions with cost, token, latency, and failure regression gates.
...
* [Stryker Mutator](https://github.com/stryker-mutator/stryker-js) ⭐ 3,087 | 🐛 109 | 🌐 TypeScript | 📅 2026-09-04 🆓 - Mutation testing framework that pairs well with AI test generators.
...
* [Faker.js](https://github.com/faker-js/faker) ⭐ 15,483 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-06 🆓 - Standard fake data library, often paired with AI for context-aware data.
* [Datafaker](https://github.com/datafaker-net/datafaker) ⭐ 1,792 | 🐛 12 | 🌐 Java | 📅 2026-09-04 🆓 - Java/Kotlin port of Faker for realistic fake data generation in JVM-based test suites.
...
* [MSW (Mock Service Worker)](https://github.com/mswjs/msw) ⭐ 18,185 | 🐛 41 | 🌐 TypeScript | 📅 2026-07-24 🆓 - API mocking library for browser and Node.js, ideal for frontend AI testing.
* [Mockoon](https://github.com/mockoon/mockoon) ⭐ 8,389 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-04 🆓 - GUI-based open source API mocking tool, easy to set up.
* [WireMock](https://github.com/wiremock/wiremock) ⭐ 7,358 | 🐛 501 | 🌐 Java | 📅 2026-09-01 🆓💰 - Industry standard HTTP mocking with 7.1k stars and a native MCP server in the cloud version for AI coding assistants.
* [Hoverfly](https://github.com/SpectoLabs/hoverfly) ⭐ 2,512 | 🐛 33 | 🌐 Go | 📅 2026-09-03 🆓 - Lightweight service virtualization with proxy-based recording and replay.
* [Mountebank](https://github.com/mountebank-testing/mountebank) ⭐ 2,106 | 🐛 105 | 🌐 JavaScript | 📅 2026-09-04 🆓 - Mature open source service virtualization for HTTP, HTTPS, TCP, and SMTP protocols. Supports stubbing, mock verification, and record-playback.
...
* [k6](https://github.com/grafana/k6) ⭐ 31,398 | 🐛 814 | 🌐 Go | 📅 2026-09-06 🆓💰 - Open-source load testing tool, increasingly paired with AI for scenario generation.
...
* [Pa11y](https://github.com/pa11y/pa11y) ⭐ 4,511 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-28 🆓 - Open-source automated accessibility testing tool.
...
* [Keploy](https://github.com/keploy/keploy) ⭐ 18,441 | 🐛 723 | 🌐 Go | 📅 2026-09-06 🆓 - Generates API tests and mocks from real traffic, with AI assertion generation.
...
* [Garak](https://github.com/NVIDIA/garak) ⭐ 9,126 | 🐛 417 | 🌐 Python | 📅 2026-09-04 🆓 - LLM vulnerability scanner from NVIDIA.
* [Guardrails AI](https://github.com/guardrails-ai/guardrails) ⭐ 7,365 | 🐛 80 | 🌐 Python | 📅 2026-09-04 🆓💰 - Python framework for validating and structuring LLM outputs using composable validators covering toxicity, PII leakage, and hallucination detection.
* [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) ⭐ 7,073 | 🐛 218 | 🌐 Python | 📅 2026-09-04 🆓 - Open-source toolkit from NVIDIA for adding programmable guardrails to LLM-based conversational systems, preventing jailbreaks, topic drift, and unsafe outputs.
* [Giskard](https://github.com/Giskard-AI/giskard) ⭐ 5,803 | 🐛 62 | 🌐 Python | 📅 2026-09-04 🆓💰 - Testing framework for LLMs and ML models.
...
* [DeepTeam](https://github.com/confident-ai/deepteam) ⭐ 2,746 | 🐛 64 | 🌐 Python | 📅 2026-08-21 🆓 - LLM red teaming for prompt injection, jailbreaks, and data leaks.
...
* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 112,669 | 🐛 397 | 🌐 Python | 📅 2026-09-05 🆓 - Make websites accessible to AI agents.
* [Lightpanda](https://github.com/lightpanda-io/browser) ⭐ 34,594 | 🐛 99 | 🌐 Zig | 📅 2026-09-06 🆓 - Headless browser written in Zig, optimized for AI agents and scraping workloads.
* [Stagehand](https://github.com/browserbase/stagehand) ⭐ 24,159 | 🐛 348 | 🌐 TypeScript | 📅 2026-09-06 🆓 - AI browser automation with predictable yet flexible APIs.
* [Skyvern](https://github.com/Skyvern-AI/skyvern) ⭐ 22,939 | 🐛 224 | 🌐 Python | 📅 2026-09-06 🆓💰 - Automate browser-based workflows using LLMs and computer vision.
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,597 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-03 🆓 - Open-source browser API for AI agents.
* [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) ⭐ 4,366 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04 🆓 - Patched Playwright for stealth automation.
* [Notte](https://github.com/nottelabs/notte) ⭐ 2,001 | 🐛 10 | 🌐 Python | 📅 2026-09-06 🆓 - Web agent framework for building fast, cost-efficient AI agents that automate web interactions using natural language instructions, with browser session management, structured data extraction, and anti-detection support.
* [AgentQL](https://github.com/tinyfish-io/agentql) ⭐ 1,456 | 🐛 7 | 🌐 Python | 📅 2026-08-26 🆓💰 - Natural language query language for AI agents to interact with and extract structured data from web pages, with self-healing selectors that integrate with Playwright.
...
* [SWE-bench](https://github.com/princeton-nlp/SWE-bench) ⭐ 5,785 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - Benchmark for evaluating LLMs on real software engineering tasks, including test fixes.
* [AgentBench](https://github.com/THUDM/AgentBench) ⭐ 3,714 | 🐛 76 | 🌐 Python | 📅 2026-02-08 🆓 - ICLR 2024 benchmark for evaluating LLMs as autonomous agents across eight environments including OS, database, web browsing, and game tasks.
* [HumanEval](https://github.com/openai/human-eval) ⭐ 3,367 | 🐛 45 | 🌐 Python | 📅 2025-01-17 - Evaluating large language models trained on code.
* [OSWorld](https://github.com/xlang-ai/OSWorld) ⭐ 3,125 | 🐛 202 | 🌐 Python | 📅 2026-08-30 🆓 - NeurIPS 2024 benchmark for evaluating multimodal AI agents on open-ended tasks in real computer environments, supporting VMware, Docker, and AWS virtualization.
* [HELM](https://github.com/stanford-crfm/helm) ⭐ 2,902 | 🐛 104 | 🌐 Python | 📅 2026-09-01 🆓 - Stanford CRFM's open-source Python framework for holistic, reproducible, and transparent evaluation of LLMs and multimodal models across dozens of scenarios covering accuracy, robustness, efficiency, bias, and safety.
* [WebArena](https://github.com/web-arena-x/webarena) ⭐ 1,601 | 🐛 103 | 🌐 Python | 📅 2025-11-26 - Self-hostable web environment for building and evaluating autonomous agents on realistic, multi-site tasks.
* [tau-bench](https://github.com/sierra-research/tau-bench) ⭐ 1,424 | 🐛 53 | 🌐 Python | 📅 2026-03-18 - Benchmark for evaluating tool-using language agents through dynamic conversations with simulated users and domain-specific APIs.
* [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐ 936 | 🐛 43 | 🌐 Python | 📅 2025-07-16 🆓 - Contamination-free holistic benchmark for evaluating LLM coding abilities that continuously collects problems from LeetCode, AtCoder, and CodeForces, covering code generation, execution, and test output prediction.
...
* [awesome-test-automation](https://github.com/atinfo/awesome-test-automation) ⭐ 7,152 | 🐛 134 | 📅 2025-11-28 - General test automation across languages.
* [awesome-llm-security](https://github.com/corca-ai/awesome-llm-security) ⭐ 1,692 | 🐛 208 | 📅 2025-08-20 - LLM security tools and resources.
* [awesome-mutation-testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 471 | 🐛 2 | 📅 2026-09-04 - Mutation testing resources.
* [awesome-testing-tools](https://github.com/ZoranPandovski/awesome-testing-tools) ⭐ 371 | 🐛 40 | 🌐 CSS | 📅 2026-08-27 - General testing tools.
